...
export const BottomNav = () => {
  ...
  return (
    <div className={cn("fixed bottom-0 left-0 right-0 bg-card-bg/90 backdrop-blur-md border-t border-surface-200/80 pb-safe pt-2 px-4 shadow-[0_-4px_20px_rgba(15,23,42,0.05)] z-50 print:hidden", keyboardOpen && "hidden")}>
          ...
          return (
            <NavLink
              ...
              className={({ isActive }) => cn(
                ...
                isActive ? "text-primary-700 dark:text-primary-400" : "text-text-secondary hover:text-text-primary"
              )}
            >
              <div className="relative">
                ...
                {isActive && (
                  <motion.div
                    ...
                    className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-1 h-1 rounded-full bg-primary-600"
                  />
                )}
              </div>
