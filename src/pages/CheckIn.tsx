...
export default function CheckIn() {
  ...
  // Bloqueio de horário: Check-in disponível das 08:00 às 16:00
  const isOpen = brtMinutes >= (8 * 60) && brtMinutes < (16 * 60);
    ...
    <div className="flex flex-col min-h-screen bg-surface-50 pb-24">
      ...
      <div className="bg-card-bg border-b border-surface-100 px-5 pt-10 pb-5">
        ...
        <p className="text-sm text-text-secondary mt-1">
          {isOpen ? 'Janela de check-in aberta' : 'Disponível das 08:00 às 16:00'}
        </p>
      </div>
      ...
      <div className="flex-1 px-5 pt-6 space-y-5">
        ...
        <div className="flex flex-col items-center py-6 gap-5">
          ...
          <div className={cn(
            ...
            <Clock size={13} />
            {isOpen ? 'Aberto · 08:00–16:00' : 'Fechado · abre às 08:00'}
          </div>
        ...
        {!alreadyDone && step === 'idle' && queue.length === 0 && (
          <div className="space-y-2.5 pt-2">
            {[
               ...
               { icon: Clock,    label: 'Horário de check-in', value: '08:00 – 16:00' },
