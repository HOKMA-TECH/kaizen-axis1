...
runTest('sale without closed_at and no history returns null date (not counted in any month)', () => {
  const client = {
    stage: 'Concluído',
...
runTest('sale without closed_at and empty history returns null (updated_at not used as sale date)', () => {
  const client = {
    stage: 'Concluído',
