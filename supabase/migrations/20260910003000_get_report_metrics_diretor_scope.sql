-- Recorte DIRETOR em get_report_metrics (cópia da 20260224170000 com recorte).
...
BEGIN
    ...
    SELECT UPPER(COALESCE(role, '')), directorate_id INTO v_user_role, v_directorate_id
    ...
    WHERE 
        ...
        (v_user_role IN ('DIRETOR', 'GERENTE', 'COORDENADOR') AND l.directorate_id = v_directorate_id) OR
    ...
    WHERE 
        (v_user_role = 'ADMIN') OR
        (v_user_role IN ('DIRETOR', 'GERENTE', 'COORDENADOR') AND c.directorate_id = v_directorate_id) OR
